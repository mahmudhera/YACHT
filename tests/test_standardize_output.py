...
class TestScript:
    def test_everything_exists():
        ...
        yacht_output = os.path.join(os.path.dirname(__file__), 'testdata/result.xlsx')
        assert os.path.exists(yacht_output)

        genome_to_taxid = os.path.join(os.path.dirname(__file__), 'testdata/toy_genome_to_taxid.tsv')
